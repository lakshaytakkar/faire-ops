...
export default function HqPostsPage() {
  return (
    <div className="max-w-[1440px] mx-auto w-full space-y-5">
      ...
      <KPIGrid>
        <MetricCard label="Total" value={0} icon={Image} iconTone="blue" />
        <MetricCard label="Active" value={0} icon={Image} iconTone="emerald" />
        <MetricCard label="Pending" value={0} icon={Image} iconTone="amber" />
        <MetricCard label="At risk" value={0} icon={Image} iconTone="red" />
      </KPIGrid>
