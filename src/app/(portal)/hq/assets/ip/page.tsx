...
const _DOCS_TITLE = "IP & Intangibles — Assets | HQ | Suprans"
...
export default function HqLicensesPage() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto w-full space-y-5">
      <PageHeader
        title="IP & Intangibles"
        subtitle="SaaS, subscriptions, domains, trademarks, copyrights, patents — everything non-tangible."
        actions={
      ...
      <DetailCard title="All items">
        {loading ? (
          ...
          <EmptyState
            icon={KeyRound}
            title={licenses.length === 0 ? "No items yet" : "No items match"}
            description={
              licenses.length === 0
                ? "Add your first subscription, domain, or trademark to start tracking."
