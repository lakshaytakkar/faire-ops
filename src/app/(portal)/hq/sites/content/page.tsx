...
export default function HqSiteContentPage() {
  return (
    <div className="max-w-[1440px] mx-auto w-full space-y-5">
      <PageHeader
        title="Site Content"
        subtitle="All content items. Filter, sort, and open a content item for full details."
      />
      ...
      <DetailCard title="All content items">
        <EmptyState
          icon={FileText}
