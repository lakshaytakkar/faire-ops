  ...
  return (
    <div className="max-w-[1440px] mx-auto w-full space-y-5">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">
            Faire seller guides, best practices, and help articles
          </p>
        </div>
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Search articles and help docs..."
          value={search}
      ...
      <div className="space-y-8">
        {Object.keys(helpByCategory).length === 0 && search ? (
          <p className="text-sm text-muted-foreground py-4 text-center">No help articles match your search</p>
        ) : (
