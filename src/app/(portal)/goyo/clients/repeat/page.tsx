...
export const metadata = { title: "Repeat clients — Goyo | Suprans" }
...
export default async function GoyoRepeatClientsPage() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto w-full space-y-5">
      <PageHeader
        ...
        subtitle={`${total.toLocaleString("en-IN")} client${total === 1 ? "" : "s"} with 2+ bookings`}
        actions={
          <GenericAddLauncher
            table="clients"
      ...
      <DetailCard title="Repeat clients">
        {rows.length === 0 ? (
          <EmptyState
            icon={UserCircle}
            title="No repeat clients yet"
            description="Clients with 2 or more bookings will appear here."
          />
        ) : (
