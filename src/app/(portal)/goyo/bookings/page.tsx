...
export const metadata = { title: "Bookings — Goyo | Suprans" }
...
export default async function GoyoBookingsPage() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto w-full space-y-5">
      <PageHeader
        title="Bookings"
        subtitle={`${total.toLocaleString("en-IN")} booking${total === 1 ? "" : "s"}`}
        actions={
          <GenericAddLauncher
            table="bookings"
      ...
      <DetailCard title="All bookings">
        {bookings.length === 0 ? (
          <EmptyState
            ...
            description="Add your first booking to start tracking departures, payments, and visas."
          />
        ) : (
