...
export const metadata = { title: "Completed bookings — Goyo | Suprans" }
...
export default async function GoyoCompletedBookingsPage() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto w-full space-y-5">
      <PageHeader
        title="Completed"
        subtitle={`${total.toLocaleString("en-IN")} completed booking${total === 1 ? "" : "s"}`}
        actions={
          <GenericAddLauncher
            table="bookings"
      ...
      <DetailCard title="Completed">
        {bookings.length === 0 ? (
          <EmptyState
            ...
            description="Bookings will appear here once their status moves to completed."
          />
        ) : (
