...
export const metadata = { title: "Upcoming bookings — Goyo | Suprans" }
...
export default async function GoyoUpcomingBookingsPage() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto w-full space-y-5">
      <PageHeader
        ...
        subtitle={`${total.toLocaleString("en-IN")} departing on or after ${formatDate(today)}`}
        actions={
          <GenericAddLauncher
            table="bookings"
      ...
      <DetailCard title="Upcoming bookings">
        {bookings.length === 0 ? (
          <EmptyState
            icon={CalendarClock}
            title="No upcoming bookings"
            description="When new bookings are created with a future departure date, they will appear here."
          />
        ) : (
