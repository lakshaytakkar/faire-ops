...
export const PLUGIN_CATEGORIES: PluginCategory[] = [
  ...
  {
    name: "Dev & Builder",
    blurb: "The engineering desk — repos, deploys, monitoring, design handoff, and the entire project portfolio.",
    plugins: [
      { name: "Development", description: "The full engineering space — overview, projects, deployments, roadmap, tasks.", icon: Code2, status: "installed", href: "/development" },
      { name: "Projects Portfolio", description: "Every landing, portal, and app Suprans ships — grouped by venture.", icon: LayoutTemplate, status: "installed", href: "/development/projects" },
      { name: "Tasks", description: "Development-space work items: in-progress, blocked, in-review, completed.", icon: ListOrderedIcon, status: "installed", href: "/development/tasks" },
      { name: "Deployments", description: "Real Vercel deployment feed via webhook + daily backfill, with detail drill-down.", icon: Rocket, status: "installed", href: "/development/deployments" },
      { name: "Roadmap", description: "Quarterly themes plus reverse-chronological changelog in one place.", icon: MapIcon, status: "installed", href: "/development/roadmap" },
      { name: "AI QA", description: "AI-assisted QA dashboard for release testing.", icon: ShieldCheck, status: "installed", href: "/hq/calls/dashboard" },
      { name: "GitHub", description: "Repo activity, open PRs, review queue, and merge status for every project.", icon: GithubIcon, status: "pending" },
      { name: "Vercel", description: "Deploy status and build logs for every Next.js and Vite project in the ecosystem.", icon: Triangle, status: "pending" },
      { name: "Supabase Console", description: "Schema, migrations, RLS policies, edge functions, and storage buckets in one view.", icon: Database, status: "pending" },
      { name: "Sentry", description: "Captured exceptions with stack traces and source maps across every app.", icon: AlertTriangle, status: "pending" },
      { name: "Linear", description: "Engineering issue tracking that syncs with our sprint + roadmap surfaces.", icon: LinearIcon, status: "pending" },
      { name: "PostHog", description: "Product analytics and feature flags for every customer-facing property.", icon: Activity, status: "pending" },
      { name: "Cloudflare", description: "DNS, edge routing, and WAF rules for every Suprans domain.", icon: Cloud, status: "pending" },
      { name: "DataDog", description: "Infra monitoring and synthetic uptime checks for the whole ecosystem.", icon: Gauge, status: "pending" },
      { name: "Figma", description: "Design files with code-connect mappings back to component libraries.", icon: PenLine, status: "pending" },
      { name: "Stripe", description: "Subscription + one-time billing for USDrop AI, LegalNations, and TeamSync paid tiers.", icon: CreditCard, status: "pending" },
  ...
  },
  {
    ...
    plugins: [
      ...
      { name: "Stack", description: "Your full app stack — favorites, subscriptions and credentials in one grid.", icon: LayoutGrid, status: "installed", href: "/workspace/stack" },
    ],
  },
]
