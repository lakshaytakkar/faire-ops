    ...
    <div className="shrink-0 h-12 w-full bg-card border-t border-slate-300 flex items-stretch z-30">
      ...
      <form onSubmit={handleSearchSubmit} className="flex-1 max-w-2xl flex items-center px-3">
        <div className="relative w-full">
          ...
          />
          <kbd className="absolute right-2 top-1/2 -translate-y-1/2 hidden md:inline-flex items-center gap-0.5 h-5 px-1.5 rounded bg-background border border-slate-300 text-xs font-mono text-muted-foreground pointer-events-none">
            <span>⌘</span>K
          </kbd>
        </div>
      </form>
